...
# TODO: Добавить в предобработку датасетов удаление наблюдений с "_trans"
...
# default_tokenizer.decode([1332, 1276, 1918, 1733, 1166, 1170, 1977, 1121, 1012, 1503, 1142, 1502, 2034, 1820, 1166, 1170, 1977, 1121, 1012, 1563, 4383, 2097, 227, 1136, 4720, 4452, 1249, 12753, 1099, 2799, 1560, 225, 1036, 1134, 220, 1759, 1559, 1206, 1012])
...
def filter_for_seq2seq(examples, max_sentence_length=None):
    assert max_sentence_length is not None, "You should provide max_sentence_length"

    ids_spoken, ids_written = examples["spoken_ids"], examples["written_ids"]

    return max(len(ids_spoken), len(ids_written)) < max_sentence_length
